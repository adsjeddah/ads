            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-2xl border-2 border-green-200">
                ...
                <p className="text-lg text-gray-600 mb-6">
                  لأي استفسار أو مساعدة، تواصل معنا عبر الواتساب
                </p>
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center gap-3 bg-gradient-to-r from-green-500 to-green-600 text-white px-10 py-5 rounded-full text-2xl font-bold shadow-lg hover:shadow-2xl transition-all"
                >
