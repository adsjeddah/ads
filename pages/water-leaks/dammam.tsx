    ...
    <section className="py-24 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden" ref={reviewsRef}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            تجارب حقيقية من عملاء استخدموا دليلنا للوصول إلى أفضل شركات كشف تسربات المياه في الدمام
          </motion.p>
        </motion.div>
...
export default function WaterLeaksDammam() {
  ...
  return (
    <>
      <Head>
        <title>دليل شركات كشف تسربات المياه في الدمام | أفضل خدمات كشف وإصلاح تسربات المياه</title>
        <meta name="description" content="اعثر على أفضل شركات كشف تسربات المياه في الدمام. خدمات احترافية، أسعار منافسة، وضمان سلامة أثاثك." />
          ...
          <div className="relative container mx-auto px-4 py-8 md:py-20">
            ...
            >
              <h1 className="text-3xl md:text-5xl font-bold mb-3 md:mb-6">
                ...
                <br />
                <span className="text-gray-800">في مدينة الدمام 🏖️</span>
              </h1>
        ...
        <footer id="contact" className="bg-gray-900 text-white py-12">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              <div className="text-center md:text-right">
                ...
                <p className="text-gray-300 mb-4">
                  دليل شامل لأفضل شركات كشف تسربات المياه في الدمام، نساعدك في العثور على الشركة المناسبة لاحتياجاتك.
                </p>
              </div>
            ...
            <div className="border-t border-gray-800 pt-8 text-center">
              <p className="text-gray-400">جميع الحقوق محفوظة © 2025 دليل شركات كشف تسربات المياه في الدمام</p>
            </div>
          </div>
        </footer>
