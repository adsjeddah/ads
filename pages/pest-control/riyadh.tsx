    ...
    <section className="py-24 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden" ref={reviewsRef}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            تجارب حقيقية من عملاء استخدموا دليلنا للوصول إلى أفضل شركات مكافحة الحشرات في الرياض
          </motion.p>
        </motion.div>
...
export default function PestControlRiyadh() {
  ...
  return (
    <>
      <Head>
        <title>دليل شركات مكافحة الحشرات في الرياض | أفضل خدمات مكافحة الحشرات والقوارض</title>
        <meta name="description" content="اعثر على أفضل شركات مكافحة الحشرات في الرياض. خدمات احترافية، أسعار منافسة، وضمان سلامة أثاثك." />
        ...
        <footer id="contact" className="bg-gray-900 text-white py-12">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              <div className="text-center md:text-right">
                ...
                <p className="text-gray-300 mb-4">
                  دليل شامل لأفضل شركات مكافحة الحشرات في الرياض، نساعدك في العثور على الشركة المناسبة لاحتياجاتك.
                </p>
              </div>
            ...
            <div className="border-t border-gray-800 pt-8 text-center">
              <p className="text-gray-400">جميع الحقوق محفوظة © 2025 دليل شركات مكافحة الحشرات في الرياض</p>
            </div>
          </div>
        </footer>
      </div>
