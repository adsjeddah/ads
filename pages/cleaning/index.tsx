    ...
    <section className="py-24 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden" ref={reviewsRef}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            تجارب حقيقية من عملاء استخدموا دليلنا للوصول إلى أفضل شركات النظافة في المملكة
          </motion.p>
        </motion.div>
...
export default function CleaningIndex() {
  ...
  const handleWhatsApp = (whatsapp: string, companyName: string) => {
    const message = encodeURIComponent(`مرحباً، أريد الاستفسار عن خدمات النظافة - ${companyName}`);
  ...
  return (
    <>
      <Head>
        <title>دليل شركات النظافة في المملكة | أفضل خدمات خدمات النظافة</title>
        <meta name="description" content="اعثر على أفضل شركات النظافة في المملكة. خدمات احترافية، أسعار منافسة، وضمان سلامة أثاثك." />
            ...
            <div className="flex items-center justify-between h-16">
              ...
              <Link href="/">
                ...
                >
                  ...
                  <span className={`font-bold text-lg hidden sm:block ${scrolled ? 'text-white' : 'text-gray-900'}`}>دليل النظافة</span>
                </motion.div>
              </Link>
          ...
          <div className="relative container mx-auto px-4 py-8 md:py-20">
            ...
            >
              <h1 className="text-3xl md:text-5xl font-bold mb-3 md:mb-6">
                <span className="text-gradient">دليل شركات النظافة</span>
                <br />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto">
                  <Link href="/cleaning/jeddah">
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-600 mt-2">شركات النظافة في جدة</p>
                    </motion.div>
                  </Link>

                  <Link href="/cleaning/riyadh">
                    <motion.div
                      whileHover={{ scale: 1.05, y: -5 }}
                      className="bg-white rounded-xl shadow-lg p-6 text-center cursor-pointer border-2 border-transparent hover:border-primary-500 transition-all"
                    >
                      ...
                      <p className="text-sm text-gray-600 mt-2">شركات النظافة في الرياض</p>
                    </motion.div>
                  </Link>

                  <Link href="/cleaning/dammam">
                    <motion.div
                      whileHover={{ scale: 1.05, y: -5 }}
                      className="bg-white rounded-xl shadow-lg p-6 text-center cursor-pointer border-2 border-transparent hover:border-primary-500 transition-all"
                    >
                      ...
                      <p className="text-sm text-gray-600 mt-2">شركات النظافة في الدمام</p>
                    </motion.div>
                  </Link>
                </div>
              </div>
        ...
        <footer id="contact" className="bg-gray-900 text-white py-12">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              ...
              <div className="text-center md:text-right">
                ...
                <p className="text-gray-300 mb-4">
                  دليل شامل لأفضل شركات النظافة في المملكة، نساعدك في العثور على الشركة المناسبة لاحتياجاتك.
                </p>
              </div>
            ...
            <div className="border-t border-gray-800 pt-8 text-center">
              <p className="text-gray-400">جميع الحقوق محفوظة © 2025 دليل شركات النظافة في المملكة</p>
            </div>
          </div>
        </footer>
